...
export const ROLES = {
  ...
  anchor:    { name:'앵커',   short:'게이지를 끌어온다', headline:'달린 거리만큼 게이지를 통째로 끌어온다', detail:'번개에서 얻은 마일리지(버프 포함)만큼 상대팀 게이지에서 깎는 동시에 내 팀 게이지에 더합니다. 한 번에 양쪽을 움직여 일반 러너의 2배 값어치를 냅니다. 예: 20km면 상대 −20 / 내 팀 +20.' },
