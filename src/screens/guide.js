...
<div class="game-section" id="gs-guide">
  <div class="scroll-body" style="padding:calc(var(--safe-top) + 12px) 18px 40px">
    ...
    ${section('🎭', '팀 및 특수 역할 배정', `
      ${para('전체 참가자는 <span style="color:#38bdf8; font-weight:700;">페이서팀</span>과 <span style="color:#c084fc; font-weight:700;">고스트팀</span>, 두 팀으로 나뉘어 함께 달리며 대결합니다.<br/>게임 시작 시 팀과 5가지 특수 역할이 모두 랜덤으로 배정되며, 각 팀에는 엘리트, 앵커, 더블, 탐정, 밀정이 하나씩 존재합니다.<br/>본인의 정체와 역할은 팀원들에게도 비공개입니다.')}
    ...
    ${section('⚡', '번개와 팀 고유 스킬', `
      ...
      ${row('<span style="color:#38bdf8;">\'페이서 시너지\'</span>', '참여 인원 × 50km의 마일리지를 추가 적립합니다.', '#38bdf8')}
      ${row('<span style="color:#c084fc;">\'고스트 게이지\'</span>', '상대팀 마일리지 삭감에 더해 게이지 바를 고스트 쪽으로 100km 즉시 이동시킵니다.', '#c084fc')}
