...
const FAQ_DATA = [
  ...
  { id: 'bolt', label: '번개', qs: [
    ...
    { q: '인증(사진)을 안 하면 어떻게 되나요?', a: '마감(시작 + 예상 완주 + 2시간)까지 인증이 없으면 자동 만료돼 거리의 <b>50%만</b> 적립됩니다(버프 없음). 줄다리기 기간엔 그만큼 상대 게이지도 깎여요.' },
  ]},
  { id: 'gauge', label: '게이지', qs: [
    { q: '탐색 기간과 줄다리기 기간이 뭐가 다른가요?', a: '탐색(일~수)에는 달린 만큼 <b>우리 팀만</b> 올라갑니다. 줄다리기(목~토)에는 <b>우리 +, 상대 −</b>로 전원 양방향이 돼요.' },
    { q: '게이지 정확한 숫자(km)는 언제 보나요?', a: '평소엔 막대(비율)만 보여요. 정확한 수치는 ① 투표 시간(월·목 18~22시) ② 종료 3일 전부터 ③ 종료 후에 공개됩니다.' },
  ]},
  { id: 'vote', label: '투표', qs: [
  ...
  { id: 'ability', label: '능력', qs: [
    { q: '탐정·밀정은 몇 번 쓰나요?', a: '각각 <b>주 2회</b>, 매주 초기화됩니다. 탐정은 팀, 밀정은 역할을 확인해요. 확인한 정보는 내 기기에만 표시됩니다.' },
