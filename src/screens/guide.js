...
export function guideBody() {
  return `
    ...
    ${section('⚡', '번개와 팀 고유 스킬', `
      ...
      ${row('<span style="color:#38bdf8;">\'페이서 시너지\'</span>', '달린 마일리지가 그대로 적립되고, 여기에 참여 인원 × 50km 보너스가 추가됩니다.<br/><span style="color:#71717a;">예: 3명이 10km를 달리면 → 달린 거리 30km + 보너스 150km</span>', '#38bdf8')}
      ${row('<span style="color:#c084fc;">\'고스트 게이지\'</span>', '달린 총 거리만큼 상대팀 게이지에서 당겨오고, 여기에 100km를 추가로 고스트 쪽으로 즉시 이동시킵니다.<br/><span style="color:#71717a;">예: 3명이 10km를 달리면 → 30km + 100km 당겨오기</span>', '#c084fc')}
