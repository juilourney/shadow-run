...
export function guideBody() {
  return `
    ...
    ${section('⚡', '번개와 팀 고유 스킬', `
      ...
      ${row('<span style="color:#34d399;">🤝 러닝메이트</span>', '누구인지 아무도 모르는 <b style="color:#e4e4e7;">숨은 러닝메이트</b>가 있습니다. 러닝메이트와 함께 달린 번개는 <b style="color:#e4e4e7;">함께한 인원수만큼 배수</b>로 적립됩니다(2명이면 ×2, 4명이면 ×4). 누구든 같이 달릴수록 이득이니, 혼자보다 함께 뛰어보세요.<br/><span style="color:#71717a;">2주차부터 적용 · 본인도 자신이 러닝메이트인지 모릅니다.</span>', '#34d399')}
