...
export function guideBody() {
  return `
    ...
    ${section('🎭', '팀 및 특수 역할 배정', `
      ...
      ${roleRow('⚓ 앵커', '게이지를 통째로 끌어온다', '번개에서 얻은 마일리지(버프 포함)만큼 상대팀 게이지에서 깎는 동시에 내 팀 게이지에 더합니다.<br/><b style="color:#fb7185;">줄다리기 기간(목~토)에는 상대에게서 깎는 양이 2배</b>가 되어 가장 강력합니다.')}
    ...
    ${section('⚡', '번개와 팀 고유 스킬', `
      ...
      ${row('스킬 보너스', '두 팀 모두 <b style="color:#e4e4e7;">참여 인원 × 달린 거리 × 5km</b>가 스킬 효과로 들어갑니다. 인원이 많고 멀리 달릴수록 커집니다.<br/><span style="color:#71717a;">예: 3명이 10km → 150km · 4명이 10km → 200km</span>')}
      ${row('<span style="color:#38bdf8;">\'페이서 시너지\'</span>', '달린 마일리지가 그대로 적립되고, 스킬 보너스 전부가 우리 팀 게이지에 추가됩니다.<br/><span style="color:#71717a;">예: 4명이 10km → 달린 거리 40km + 시너지 200km 적립</span>', '#38bdf8')}
      ${row('<span style="color:#c084fc;">\'고스트 게이지\'</span>', '스킬 보너스를 절반씩 나눠 <b style="color:#e4e4e7;">상대 게이지에서 깎고 우리 게이지에 더합니다</b>(당겨오기). 총 효과는 시너지와 같지만, 상대가 쌓아둔 것을 직접 지웁니다.<br/><span style="color:#71717a;">예: 4명이 10km → 상대 −100km / 우리 +100km</span>', '#c084fc')}
